...
public final class ItemRegistry {
    ...
    // Bows
    public static RegistryObject<H3KBowItem> IRON_BOW = ITEMS.register("iron_bow", () -> new H3KBowItem(1.5, 1, new Item.Properties().durability(1627).tab(H3KsToolsMod.ITEM_GROUP)));
    public static RegistryObject<H3KBowItem> GOLD_BOW = ITEMS.register("gold_bow", () -> new H3KBowItem(1, 2, new Item.Properties().durability(208).tab(H3KsToolsMod.ITEM_GROUP)));
    public static RegistryObject<H3KBowItem> DIAMOND_BOW = ITEMS.register("diamond_bow", () -> new H3KBowItem(1.75, 1, new Item.Properties().durability(10160).tab(H3KsToolsMod.ITEM_GROUP)));
